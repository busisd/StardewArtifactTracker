data = {
'''
The data variable above should be set to the value of the unpacked version of Locations.xnb.
A quick guide is as follows:
 - Find the file Locations.xnb
   > Try C:\Program Files (x86)\Steam\steamapps\common\Stardew Valley\Content\Data
 - Unpack Locations.xnb into a .json file
